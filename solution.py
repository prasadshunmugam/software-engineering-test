...
class SupahandsBadger:
    ...
    def generateSeed(self):
        ...
        return ['2021-03-13 15:13:05', '2021-03-13 23:13:05', '2021-03-16 15:13:05', '2021-03-16 23:13:05', '2021-03-17 07:13:05', '2021-03-17 15:13:05', '2021-03-17 23:13:05', '2021-03-18 07:13:05', '2021-03-18 15:13:05']
    ...
    def calculateConsecutiveLogins(self, sortedLoginDates, loginCountMap):
        ...
        endDate    = ""
        count      = 0
        print('\nsortedLoginDates: ',sortedLoginDates)
        # print('loginCountMap: ',loginCountMap)

        for idx in range(1,len(sortedLoginDates)):
            print('\nsortedLoginDates[idx]: ',sortedLoginDates[idx])
            currentDate = sortedLoginDates[idx]
            previousDay = currentDate - datetime.timedelta(days=1)
            print(previousDay, currentDate)

            if sortedLoginDates[idx-1] == previousDay:
                count += 1
            else:
                count += 1
                endDate = str(sortedLoginDates[idx-1])
